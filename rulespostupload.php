  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <input type="file" name="image" id="image" /> 
      		...
      		<input type="text" name="post" class="form-control" placeholder="Enter Description" >
      	</div>
        <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="rulespostuploadbtn" id="rulespostuploadbtn" value="rulespostuploadbtn" >Save changes</button>
      </div>
      </form>
	...
	<div class="card shadow-mb-4">
		<div class="card-header py-3 ">
			<h6 class="m-0 front-weight-bolt text-primary">Postupload section
    ...
    <tr>
      ...
      <td><?php echo  '<img src="data:image/jpeg;base64,'.base64_encode($row['image']).'" height="100" width="100"/>';     ?>  </td>
       <td><?php echo $row['link']; ?>  </td>
                ...
                <td>
            <form action="rulespostedit.php" method="POST">
          ...
          <form action="code.php" method="POST">
           ...
           <button type="submit" name="rulespost_deletbtn" class="btn btn-danger">DELETE</button> 
           </form>
