...
class PDF extends FPDF {
	function Header(){
		...
		$this->Cell(60,5,'Allergies',1,0,'',true);
		$this->Cell(60,5,'Tobbaco',1,0,'',true);
		$this->Cell(60,5,'Alcohol',1,0,'',true);
		$this->Cell(60,5,'Drugs',1,1,'',true);
...
while($data=mysqli_fetch_array($query)){
	...
	$pdf->Cell(60,5,$data['c_allergies'],'LR',0);
	$pdf->Cell(60,5,$data['c_tobbaco'],'LR',0);
	$pdf->Cell(60,5,$data['c_alcohol'],'LR',0);
	$pdf->Cell(60,5,$data['c_drugs'],'LR',0);
