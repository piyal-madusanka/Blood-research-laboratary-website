        ...
        <section class="medica-services-area section_padding_100">
            <div class="container">
                       <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><a><h4>Registered Customers can <br> Receive Invoices</h4></a></h4>
                                      <div class="row">
                    ...
                    <div class="medica-department-card">
                          ...
                          <li><a href="#"><h4 style="color: white;">Payment Reminder notices</h4></a></li>
                ...
                <div class="col-12 col-md-2 col-lg-2">
                    ...
                    <div class="medica-department-card">
                            <h5></h5>
                            <ul class="department-menu">
                          <li><a href="#"><h4 style="color: white;">Payment Informations</h4></a></li>
