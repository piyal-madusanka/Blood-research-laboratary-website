                            ...
                            <div class="row">
                                <div class="card text-white bg-info mb-3" style="max-width: 100rem; width: 100rem">
                                    ...
                                    <div  class="card bg-light text-dark" >
                                        ...
                                        <div class="card-body">
                                            <h5>search tests</h5>
                                            <form class="form-inline my-2 my-lg-2" action="search2.php" method="POST">
                                                <input style="max-width: 100rem; width: 100rem" class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name="search">
