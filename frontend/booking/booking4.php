...
if(a.includes('Gampaha')==false){
  ...
  <div class="card-header">
   <h4><strong>Ambulance Available time Slots</strong> </h4>
						...
						<form action="../login-check/available_check3.php" method="POST" onsubmit="return myfun()">
							<div class="col-md-12">
							...
							<div class="col-md-4">
								<div class="form-btn">
									<button class="submit-btn" name="book3" type="submit">Check availability</button>
								</div>
							</div>
						</form>
					</div>
